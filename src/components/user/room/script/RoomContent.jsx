    ...
    <div className="RoomView_Top">
      <div className="RoomView_container">
        <ul className="RoomView_list">
          ...
          <li className="contents_wrap room-content">
            <div className="room-header">
              <p>
                서울의 역사와 비즈니스의 중심 소공동에 위치한 HJ호텔은 최대의 규모를 갖춘 한국 최고의 럭셔리 호텔입니다.<br/>
                서울 다운타운의 중심에서 남산과 명동, 스카이라인을 감상할 수 있는 롯데호텔 서울은<br/> 세계적인 인테리어 회사들이 참가하여 설계한 독창적인 객실을 갖추고 있으며 성공적인 비즈니스를 위한 최적의 공간입니다.
              </p>
            </div>
